...
<form action="index.php?action=addFilmOK" method="POST">
    ...
    <input class="uk-input" type="text" name="titre_film" id="titre_film" required>

    <label for="realisateur">Nom du réalisateur*</label>
    <select class="uk-select" name="realisateur" id="realisateur" required>
    ...
    <input class="uk-input" type="text" name="annee_film" id="annee_film">

    <label for="duree_film">Durée (en minutes)*</label>
    <input class="uk-input" type="text" name="duree_film" id="duree_film" required>

    <label for="genres_film">Genres</label>
    <select class="uk-select" name="genres_film[]" id="genres_film" multiple>
        <option selected disabled>Choisissez une option</option>
