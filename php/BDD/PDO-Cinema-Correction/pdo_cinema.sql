...
INSERT INTO `film` (`id_film`, `titre_film`, `annee_film`, `duree_film`, `synopsis`, `affiche`, `note`, `id_realisateur`) VALUES
	...
	(8, 'David Lynch: The Art Life', '2017', 88, 'Le film documentaire David Lynch: The Art Life est un portrait inédit de l’un des cinéastes les plus énigmatiques de sa génération. De son enfance idyllique dans une petite ville d’Amérique aux rues sombres de Philadelphie, David Lynch nous entraîne dans un voyage intime rythmé par le récit hypnotique qu’il fait de ses jeunes années. En associant les œuvres plastiques et musicales de David Lynch à ses expériences marquantes, le film lève le voile sur les zones inexplorées d’un univers de création totale.', 'http://fr.web.img6.acsta.net/r_1280_720/pictures/16/12/02/11/44/425445.jpg', 4, 1),
	(9, 'What Did Jack Do?', '2020', 17, NULL, NULL, 2, 1),
	(12, 'Piège de Cristal', '1988', 120, NULL, NULL, NULL, 7),
	(13, 'Piège de Cristal', '1988', 120, NULL, NULL, NULL, 7),
	(14, 'Piège de Cristal', '1988', 120, NULL, NULL, NULL, 7);
...
-- Listage des données de la table cinema.genre_film : ~18 rows (environ)
